...
class ControllerModuleJtlconnector extends Controller
{
    ...
    public function index()
    {
        ...
        $data['url'] = $this->language->get('text_version');
        $data['version'] = $this->language->get('text_version');
        ...
        if (isset($this->request->post['connector-password'])) {
            $data['connector-password'] = $this->request->post['connector-password'];
        } else {
            $data['connector-password'] = $this->config->get('connector-password');
        }
